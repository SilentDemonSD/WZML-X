...
class _BotCommands:
    def __init__(self):
        ...
        self.DelPreNameCommand = getCommand('DELPRENAME_COMMAND', f'delprename{CMD_INDEX}')
        self.CaptionCommand = getCommand('CAPTION_COMMAND', f'caption{CMD_INDEX}')
        self.DelCaptionCommand = getCommand('DELCAPTION_COMMAND', f'delcaption{CMD_INDEX}')
        self.UserLogCommand = getCommand('DUMPID_COMMAND', f'dumpid{CMD_INDEX}')
        self.DelUserLogCommand = getCommand('DELDUMP_COMMAND', f'deldumpid{CMD_INDEX}')
