...
class BotCommands:
    ...
    StatusCommand = [f"status{Config.CMD_SUFFIX}", f"s{Config.CMD_SUFFIX}"]
    MediaInfoCommand = [f"mediainfo{Config.CMD_SUFFIX}", f"mi{Config.CMD_SUFFIX}"]
    UsersCommand = f"users{Config.CMD_SUFFIX}"
    AuthorizeCommand = [f"authorize{Config.CMD_SUFFIX}", f"a{Config.CMD_SUFFIX}"]
    UnAuthorizeCommand = [f"unauthorize{Config.CMD_SUFFIX}", f"ua{Config.CMD_SUFFIX}"]
    ...
    SelectCommand = [f"select{Config.CMD_SUFFIX}", f"sel{Config.CMD_SUFFIX}"]
