...
class _BotCommands:
    def __init__(self):
        ...
        self.PreNameCommand = getCommand(f'PRENAME_COMMAND', f'prefix{CMD_PERFIX}')
        self.SufNameCommand = getCommand(f'SUFFIX_COMMAND', f'suffix{CMD_PERFIX}')
        self.CaptionCommand = getCommand(f'CAPTION_COMMAND', f'caption{CMD_PERFIX}')
        self.UserLogCommand = getCommand(f'DUMPID_COMMAND', f'dumpid{CMD_PERFIX}')
        self.RemnameCommand = getCommand(f'REMNAME_COMMAND', f'remname{CMD_PERFIX}')
