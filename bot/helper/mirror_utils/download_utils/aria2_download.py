...
async def add_aria2c_download(
    ...
    seed_time: typing.Optional[int] = None,
    isMulti: bool = False
) -> typing.Optional[str]:
    """
    Adds a download to Aria2.

    :param link: The download link.
    :param path: The path to save the download.
    :param listener: The listener object.
    :param filename: The filename to save the download.
    :param headers: The headers for the download.
    :param ratio: The seed ratio.
    :param seed_time: The seed time.
    :param isMulti: Whether it's a multi-file download.
