...
class SplitStatus:
    ...
    def download(self) -> 'SplitStatus':
        """
        Get the SplitStatus object for the file download operation.

        :return: The SplitStatus object.
        """
        return self
    ...
    def eng(self) -> EngineStatus:
        """
        Get the engine status for the file split operation.
    ...
    def __str__(self):
        """
        Get a human-readable representation of the SplitStatus object.
