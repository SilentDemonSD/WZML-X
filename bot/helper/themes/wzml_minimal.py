class WZMLStyle:
    ...
    INDEX_LINK_D: str = '⚡ Index Link'  # Button text for index link (direct)
    VIEW_LINK: str = '🌐 View Link'  # Button text for view link
    CHECK_PM: str = '📥 View in Bot PM'  # Button text for
