...
<b>├⚡ Speed: </b>{sm23}
<b>├🔺 Uploaded: </b>{sm24}
<b>├📎 Ratio: </b>{sm25} | <b>⏲️ Time: </b>{sm26}
<b>├⏳ Elapsed: </b>{sm27}
...
<b>╰ 🔻 Download Data:</b> {s13}\n\n'''
    #---------------------
    #__main__.py#L131
    STATS_MSG_LIMITS = '''<b>╭─《 ⚠️ BOT LIMITS ⚠️ 》</b>\n\
...
<b>╰ 🔫 User Tasks: </b>{sl7}\n\n'''
    #-----------------------
    LISTENER_MSG1 = '''<b>╭🗂️ Name: </b><{lm1}>{lm2}</{lm1}>
<b>├📐 Size: </b>{lm3}
<b>├📚 Total Files: </b>{lm4}
<b>├⌛ It Tooks:</b> {lm5}
<b>╰👤 #Leech_by: </b>{lm6}\n\n'''
    LISTENER_MSG2 = '''<b>├💀 Corrupted Files: </b>{lm7}'''
    LISTENER_MSG3 = '''<b>╭🗂️ Name: </b><{lm8}>{lm9}</{lm8}>
<b>├📐 Size: </b>{lm10}
<b>├📦 Type: </b>{lm11}
<b>├⌛ It Tooks:</b> {lm12}
<b>╰👤 #Mirror_By: </b>{lm13}\n\n'''
    LISTENER_MSG4 = '''<b>├🗃️ SubFolders: </b>{lm14}
<b>├🗂️ Files: </b>{lm15}'''
    LISTENER_HIDE_MSG1 = '''<b>🗂️ Name: </b><{lhm1}>{lhm2}</{lhm1}>'''
    LISTENER_HIDE_MSG2 = '''<b>🗂️ Name: </b><{lhm3}>{lhm4}</{lhm3}>'''
    LISTENER_BUTTON1 = '''"☁️ Drive Link", {lb1}'''
