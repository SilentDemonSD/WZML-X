...
def broadcast(update, context):
    ...
    if not config_dict['DATABASE_URL']:
        context.bot.send_message(chat_id=update.effective_chat.id, text="DATABASE_URL not provided")
        return
    ...
    try:
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text=f"Error connecting to database: {e}")
        return
