...
DEFAULT_DESP = {
    ...
    "DISABLE_RAPIDGATOR": "Disable Rapidgator Processor for bot. Default: False.",
    ...
    "RAPIDGATOR_EMAIL": "Rapidgator account email for global premium downloads.",
    ...
    "RAPIDGATOR_LIMIT": "Rapidgator download size limit in GB. 0 = unlimited.",
